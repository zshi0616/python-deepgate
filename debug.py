...
if __name__ == '__main__':
    ...
    trainer.set_training_args(prob_rc_func_weight=[2.0, 1.0, 0.0], lr=2e-4, lr_step=-1)
    print('[INFO] Stage 1 Training ...')
    trainer.train(num_epochs, train_dataset, val_dataset)
    
    print('[INFO] Stage 2 Training ...')
    trainer.set_training_args(prob_rc_func_weight=[3.0, 1.0, 2.0], lr=2e-4, lr_step=-1)
    trainer.train(num_epochs, train_dataset, val_dataset)
